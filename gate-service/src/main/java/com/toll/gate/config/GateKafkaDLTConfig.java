...
@Configuration
@EnableKafka
public class GateKafkaDLTConfig {
    ...
    @Bean
    public KafkaTemplate<Object, Object> gateDLTKafkaTemplate() {
    ...
    public ConcurrentKafkaListenerContainerFactory<String, OpenGateCommand> gateCommandListenerFactory(
            ...
            ConsumerFactory<String, OpenGateCommand> gateCommandConsumerFactory) {
        ...
        factory.getContainerProperties().setGroupId("gate-service-group");
